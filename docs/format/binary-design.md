...
> Byte-level format spec: see [`binary-spec.md`](binary-spec.md).
...
| `laps` | Scan `.acctlm` for lap boundaries and print lap times |
| `build-lap-index` | Build lap index for existing `.acctlm` files |
